...
TODO: This program is to get the original scene without pass-by or other different objects in inserted photos
"""
    ...
    for x in range(width):
        for y in range(height):
            ...
            for i in range(len(images)):
                ...
                pixels.append(pixel)
            closest_pixel = get_best_pixel(pixels)
            b_pixel = result.get_pixel(x, y)
            b_pixel.red = closest_pixel.red
            b_pixel.green = closest_pixel.green
            b_pixel.blue = closest_pixel.blue
